  ...
  const handleViewOnline = () => {
    ...
    const resumeHTML = `
      ...
      <html>
        ...
        <body>
          <h1>Jyothish - FULL STACK DEVELOPER & AI Generalist</h1>
          <div class="section">
           
          </div>  
          
          <div class="section">
            <strong>Name:</strong> Jyothish Mypati<br>
            <strong>Role:</strong> Full Stack Developer & AI Generalist<br>
            <strong>Email:</strong> mjyothish04@gmail.com<br>
            <strong>Phone:</strong> +91 6300351586 <br>
            <strong>Location:</strong> vadakal ,Sriperumbudur, Tamil Nadu, India
          </div>
          ...
          <h2>EDUCATION</h2>
          <div class="job">
            <div class="job-title">Artificial Intelligence and Data Science, B.Tech.</div>
            <div class="company">Sri Venkateswaraa College of Technology • 2022 - 2025</div>
            <ul>
              
              <li>Focus on web development and AI Generalist</li>
            </ul>
          </div>

          <h2>SKILLS</h2>
          <div class="skills">
            <div class="skill">React (50%)</div>
            <div class="skill">JavaScript (60%)</div>
            <div class="skill">TypeScript (25%)</div>
            
            <div class="skill">Tailwind CSS (75%)</div>
            <div class="skill">Node.js (30%)</div>
            <div class="skill">Python (60%)</div>
            <div class="skill">PostgreSQL (40%)</div>
            <div class="skill">MongoDB (40%)</div>
            <div class="skill">Git (60%)</div>
            <div class="skill">MongoDB Atlas (20%)</div>
            <div class="skill">AWS (20%)</div>
            <div class="skill">Figma (15%)</div>
          </div>
        </body>
      </html>
    `;
            ...
            <div className="space-y-8">
              ...
              <div className="bg-card rounded-2xl p-8 border border-border">
                ...
                <div className="border-l-3 border-blue-500 pl-6 relative">
                  ...
                  <h4 className="font-semibold text-lg">Artificial Intelligence and Data Science, B.Tech.</h4>
                  <p className="text-sm text-muted-foreground mb-2">Sri Venkateswarra College of Technology • 2022 - 2026</p>
                  <p className="text-sm leading-relaxed"> Focus on Full-Stack development and Ai Generalist</p>
                </div>
              </div>
            </div>
          </div>
